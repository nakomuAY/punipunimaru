...
document.getElementById("chara").value=charasArray;
...
document.getElementById("situmonsu").value=resultQuestion.length;
...
for(var i=0;i < resultQuestion.length;i++){
  var num = parseInt(resultQuestion[i].substr(resultQuestion[i].lastIndexOf("question")+8,resultQuestion[i].length-resultQuestion[i].indexOf(".")));
